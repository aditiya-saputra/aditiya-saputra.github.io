---
layout: page
title: Sumber Data Terbuka
description: Daftar sumber data terbuka dalam & luar negeri yang dipakai blog ini.
permalink: /sumber-data/
---
...
- **Eksekutif & statistik:** kemendagri.go.id, kemenkeu.go.id, bps.go.id, data.go.id (Satu Data Indonesia)
- **Audit:** bpk.go.id (LHP)

## Luar Negeri 🌍
- **Demokrasi & pemilu global:** International IDEA (idea.int), V-Dem Institute (v-dem.net)
...
2. Jelaskan batas data (cakupan tahun, negara, metodologi).
3. Bedakan angka resmi vs estimasi vs hasil survei.

Punya sumber terbuka bagus yang belum ada di daftar? Kirim via [Kontak](/kontak/).
